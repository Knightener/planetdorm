...
export const dorms = [
  ...
  // NORTH CAMPUS: Cambridge Community
  {
    ...
    bathrooms: 'Community & single all-gender bathrooms',
  ...
  },
  {
    ...
    tags: [{ t: 'Integrated Life Sciences LLP', c: 'honors' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
  ...
  // NORTH CAMPUS: Heritage Community
  {
    ...
    bathrooms: 'Single all-gender bathrooms',
    ac: true, dining: 'Yahentamitsi Dining Hall',
  ...
  // SOUTH CAMPUS: North Hill Community
  {
    ...
    rating: 0, reviews: 0, type: 'Traditional', roomTypes: 'Doubles',
    bathrooms: 'Community & single all-gender bathrooms',
    ac: true, dining: 'South Campus Dining Hall',
    ...
    tags: [{ t: 'Honors Humanities LLP', c: 'honors' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
  ...
  },
  {
    ...
    rating: 0, reviews: 0, type: 'Traditional', roomTypes: 'Doubles, Triples',
    bathrooms: 'Community & single all-gender bathrooms',
    ac: false, dining: 'South Campus Dining Hall',
  ...
  },
  {
    ...
    tags: [{ t: 'Honors Global Challenges LLP', c: 'honors' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
  ...
  },
  {
    ...
    tags: [{ t: "Writers' House LLP", c: 'honors' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
  ...
  },
  {
    ...
    tags: [{ t: 'BioFIRE LLP', c: 'honors' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
  ...
  // THE COMMONS: South Hill Community
  {
    ...
    tags: [{ t: 'Suite/Apartment', c: 'good' }, { t: 'A/C', c: 'good' }, { t: 'No In-hall Laundry', c: 'bad' }],
